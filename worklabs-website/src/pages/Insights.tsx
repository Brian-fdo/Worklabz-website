        ...
        {!selectedCategory && (
          <motion.div {...fadeInUp} className="mb-12">
            <div className="bg-[#12151c] border border-white/5 rounded-3xl p-8 sm:p-12 hover:border-primary-500/20 transition-colors group">
              ...
              <Link to={`/insights/${featured.slug}`} className="flex items-center gap-2 text-primary-400 font-bold text-sm group-hover:gap-3 transition-all mt-auto pt-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {displayed.map((article, i) => (
            ...
            >
              ...
              <Link to={`/insights/${article.slug}`} className="flex items-center gap-2 text-primary-400 font-bold text-sm group-hover:gap-3 transition-all mt-auto pt-4">
                Read Article <ArrowRight className="w-4 h-4" />
              </Link>
            </motion.div>
          ))}
